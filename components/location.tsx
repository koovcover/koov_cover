    ...
    <section className="section-padding theme-bg-secondary">
      <div className="container-custom">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bebas theme-text-primary mb-4">{t('location.title')}</h2>
          <p className="text-xl theme-text-secondary">{t('location.subtitle')}</p>
        </div>

        <div className="max-w-4xl mx-auto">
          <div className="rounded-2xl overflow-hidden theme-shadow-lg theme-border border">
            <iframe
