...
const translations = {
  'pt-BR': {
    ...
    'comparison.title': 'Comparação: Capa Tradicional vs KOOV COVER',
    'comparison.subtitle': 'Análise detalhada da experiência do usuário em situações cotidianas dos motociclistas de Lima',
    'comparison.situation': 'SITUAÇÃO',
    'comparison.traditional': 'CAPA TRADICIONAL',
    'comparison.koov': 'KOOV COVER',
    'comparison.benefit': 'BENEFÍCIO REAL',
    'comparison.morning.title': 'Experiência matinal (correria)',
    'comparison.morning.traditional': 'Tirar capa, dobrar, sujar as mãos, procurar onde deixá-la',
    'comparison.morning.koov': 'Abrir porta, ligar, sair limpo',
    'comparison.morning.impact': 'Você economiza 3-5 minutos diários + sem estresse',
    'comparison.weather.title': 'Proteção em clima úmido',
    'comparison.weather.traditional': 'Condensação presa, cheiro de umidade, tecido pegajoso',
    'comparison.weather.koov': 'Ambiente seco controlado, ventilação adequada',
    'comparison.weather.impact': 'Menos ferrugem, melhor conservação das peças metálicas',
    'comparison.maintenance.title': 'Manutenção e limpeza',
    'comparison.maintenance.traditional': 'Poeira aderida, manchas permanentes, deterioração visível',
    'comparison.maintenance.koov': 'Limpeza ocasional, aparência profissional constante',
    'comparison.maintenance.impact': 'Mantém o valor de revenda da sua motocicleta',
    'comparison.daily.title': 'Uso diário habitual',
    'comparison.daily.traditional': 'Carregar volume úmido/sujo, procurar onde guardá-lo',
    'comparison.daily.impact': 'Zero complicações, máxima praticidade',
    'comparison.conclusion.title': 'Resultado: Uma experiência completamente diferente',
    'comparison.conclusion.subtitle': 'KOOV COVER não é uma "capa melhorada" - é uma solução abrangente projetada por peruanos para você',
    'comparison.stats.time': '5 MIN',
    'comparison.stats.time.desc': 'Economia diária',
    'comparison.stats.life': '3+ ANOS',
    'comparison.stats.life.desc': 'Vida útil garantida',
    'comparison.stats.hassle': 'ZERO',
    'comparison.stats.hassle.desc': 'Complicações diárias',
    'comparison.cta': 'Experimente a diferença',


    // Location
    'location.title': 'Nosso escritório',
    'location.subtitle': 'Av. Colonial 3046, Cercado de Lima',
    'location.address': 'Av. Colonial 3046, Cercado de Lima, Lima, Peru',
    'location.map': 'Ver mapa no Google Maps',
  ...
  es: {
    ...
    'comparison.conclusion.subtitle': 'KOOV COVER no es una "funda mejorada" - es una solución integral diseñada por peruanos para ti',
    'comparison.stats.time': '5 MIN',
  ...
  en: {
    ...
    'comparison.conclusion.subtitle': 'KOOV COVER is not an "improved cover" - it is a comprehensive solution designed by Peruvians for you',
    'comparison.stats.time': '5 MIN',
